...
" This won't work without cstr, https://github.com/vim/vim/issues/4687
" \vec
"syn match texMathSymbol '\\vec{a}' contained conceal cchar=a̅̅
"syn match texMathSymbol '\\vec{b}' contained conceal cchar=b̅̅
"syn match texMathSymbol '\\vec{c}' contained conceal cchar=c̅̅
"syn match texMathSymbol '\\vec{d}' contained conceal cchar=d̅̅
"syn match texMathSymbol '\\vec{e}' contained conceal cchar=e̅̅
"syn match texMathSymbol '\\vec{f}' contained conceal cchar=f̅̅
"syn match texMathSymbol '\\vec{g}' contained conceal cchar=g̅̅
"syn match texMathSymbol '\\vec{h}' contained conceal cchar=h̅̅
"syn match texMathSymbol '\\vec{i}' contained conceal cchar=i̅
"syn match texMathSymbol '\\vec{j}' contained conceal cchār=j̅
"syn match texMathSymbol '\\vec{k}' contained conceal cchar=k̅̅
"syn match texMathSymbol '\\vec{l}' contained conceal cchar=l̅̅
"syn match texMathSymbol '\\vec{m}' contained conceal cchar=m̅̅
"syn match texMathSymbol '\\vec{n}' contained conceal cchar=n̅̅
"syn match texMathSymbol '\\vec{o}' contained conceal cchar=o̅̅
"syn match texMathSymbol '\\vec{p}' contained conceal cchar=p̅̅
"syn match texMathSymbol '\\vec{q}' contained conceal cchar=q̅̅
"syn match texMathSymbol '\\vec{r}' contained conceal cchar=r̅̅
"syn match texMathSymbol '\\vec{s}' contained conceal cchar=s̅̅
"syn match texMathSymbol '\\vec{t}' contained conceal cchar=t̅̅
"syn match texMathSymbol '\\vec{u}' contained conceal cchar=u̅̅
"syn match texMathSymbol '\\vec{v}' contained conceal cchar=v̅̅
"syn match texMathSymbol '\\vec{w}' contained conceal cchar=w̅̅
"syn match texMathSymbol '\\vec{x}' contained conceal cchar=x̅̅
"syn match texMathSymbol '\\vec{y}' contained conceal cchar=y̅̅
"syn match texMathSymbol '\\vec{z}' contained conceal cchar=z̅̅
"syn match texMathSymbol '\\vec{A}' contained conceal cchar=A̅̅
"syn match texMathSymbol '\\vec{B}' contained conceal cchar=B̅̅
"syn match texMathSymbol '\\vec{C}' contained conceal cchar=C̅̅
"syn match texMathSymbol '\\vec{D}' contained conceal cchar=D̅̅
...
"syn match texMathSymbol '\\vec{G}' contained conceal cchar=G̅̅
"syn match texMathSymbol '\\vec{H}' contained conceal cchar=H̅̅
"syn match texMathSymbol '\\vec{I}' contained conceal cchar=I̅̅
"syn match texMathSymbol '\\vec{J}' contained conceal cchar=J̅̅
"syn match texMathSymbol '\\vec{K}' contained conceal cchar=K̅̅
"syn match texMathSymbol '\\vec{L}' contained conceal cchar=L̅̅
"syn match texMathSymbol '\\vec{M}' contained conceal cchar=M̅̅
"syn match texMathSymbol '\\vec{N}' contained conceal cchar=N̅̅
